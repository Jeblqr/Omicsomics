...
const visualizationTools: ToolDefinition[] = [
  ...
  },
  {
    ...
    omicsType: 'General',
    operationCategory: 'Visualization',
    description: 'Generate violin plot for data distribution with density',
    parameterTemplate: [
      { name: 'show_box', type: 'boolean', label: 'Show Box', description: 'Show box plot inside violin', default: true },
      { name: 'bandwidth', type: 'number', label: 'Bandwidth', description: 'Kernel density bandwidth', default: 0.5, min: 0.1, max: 2 },
    ],
    defaultParameters: { show_box: true, bandwidth: 0.5 },
  },
  {
    id: 'viz-ma-plot',
    name: 'MA Plot',
    ...
    omicsType: 'General',
    operationCategory: 'Visualization',
    description: 'Generate MA plot (M vs A) for differential expression',
    parameterTemplate: [
      { name: 'pvalue_threshold', type: 'number', label: 'P-value Threshold', description: 'Significance threshold', default: 0.05, min: 0, max: 1 },
      { name: 'fc_threshold', type: 'number', label: 'Fold Change Threshold', description: 'Log2 fold change threshold', default: 1, min: 0, max: 10 },
    ],
  ...
  },
  {
    ...
    omicsType: 'General',
    operationCategory: 'Visualization',
    description: 'Generate scatter plot for correlation analysis',
    parameterTemplate: [
      { name: 'x_column', type: 'string', label: 'X Column', description: 'Column for X axis', required: true },
      { name: 'y_column', type: 'string', label: 'Y Column', description: 'Column for Y axis', required: true },
      { name: 'show_regression', type: 'boolean', label: 'Show Regression', description: 'Show regression line', default: true },
      { name: 'color_by', type: 'string', label: 'Color By', description: 'Column for color grouping', required: false },
    ],
    defaultParameters: { show_regression: true },
  },
  {
    id: 'viz-histogram',
    name: 'Histogram',
    ...
    omicsType: 'General',
    operationCategory: 'Visualization',
    description: 'Generate histogram for data distribution',
    parameterTemplate: [
      { name: 'bins', type: 'number', label: 'Bins', description: 'Number of bins', default: 30, min: 5, max: 100 },
      { name: 'show_kde', type: 'boolean', label: 'Show KDE', description: 'Show kernel density estimate', default: false },
    ],
    defaultParameters: { bins: 30, show_kde: false },
  },
  {
    id: 'viz-correlation-matrix',
    ...
    omicsType: 'General',
    operationCategory: 'Visualization',
    description: 'Generate correlation matrix heatmap',
    parameterTemplate: [
      { name: 'method', type: 'select', label: 'Method', description: 'Correlation method', default: 'pearson', options: ['pearson', 'spearman', 'kendall'] },
      { name: 'show_values', type: 'boolean', label: 'Show Values', description: 'Display correlation coefficients', default: true },
    ],
    defaultParameters: { method: 'pearson', show_values: true },
  },
  {
    id: 'viz-dendrogram',
    name: 'Dendrogram',
    ...
    omicsType: 'General',
    operationCategory: 'Visualization',
    description: 'Generate hierarchical clustering dendrogram',
    parameterTemplate: [
      { name: 'linkage', type: 'select', label: 'Linkage', description: 'Linkage method', default: 'average', options: ['single', 'complete', 'average', 'ward'] },
      { name: 'distance', type: 'select', label: 'Distance', description: 'Distance metric', default: 'euclidean', options: ['euclidean', 'manhattan', 'cosine', 'correlation'] },
    ],
    defaultParameters: { linkage: 'average', distance: 'euclidean' },
  },
  {
    id: 'viz-barplot',
    name: 'Bar Plot',
    ...
    omicsType: 'General',
    operationCategory: 'Visualization',
    description: 'Generate bar plot for categorical data',
    parameterTemplate: [
      { name: 'orientation', type: 'select', label: 'Orientation', description: 'Bar orientation', default: 'vertical', options: ['vertical', 'horizontal'] },
      { name: 'show_error_bars', type: 'boolean', label: 'Show Error Bars', description: 'Display error bars', default: true },
    ],
    defaultParameters: { orientation: 'vertical', show_error_bars: true },
  },
];

...
class Workflow(Base):
    ...
    workflow_type: Mapped[str] = mapped_column(String(50))  # e.g., 'nextflow', 'cwl', 'snakemake'
    ...
    output_files: Mapped[dict] = mapped_column(JSON, default=dict)  # Generated file paths

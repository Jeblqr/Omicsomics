...
class QualityControlService:
    ...
    def generate_report(unified_data: UnifiedData) -> Dict[str, Any]:
        ...
        # Calculate metrics
        missing_stats = QualityControlService._calculate_missing_values(
            records, headers
        )
        outlier_stats = QualityControlService._detect_outliers(records, headers)
        distribution_stats = QualityControlService._analyze_distribution(
            records, headers
        )
        completeness_stats = QualityControlService._calculate_completeness(
            records, headers
        )
    ...
    @staticmethod
    def _calculate_missing_values(
        records: List[Any], headers: List[str]
    ) -> Dict[str, Any]:
    ...
    def _detect_outliers(records: List[Any], headers: List[str]) -> Dict[str, Any]:
        ...
        return {
            ...
            "fields_with_high_outliers": [
                field
                for field, stats in outlier_stats.items()
    ...
    def _calculate_completeness(
        ...
        completeness_ratio = (
            complete_records / total_records if total_records > 0 else 0
        )
        ...
        return {
            ...
            "status": QualityControlService._get_completeness_status(
                completeness_ratio
            ),
        }

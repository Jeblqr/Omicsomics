...
class SearchQuery:
    ...
    def with_range(self, field: str, min_val: Optional[float] = None, max_val: Optional[float] = None) -> 'SearchQuery':
...
class DataSearchService:
    ...
    def _matches_text(feature_dict: Dict[str, Any], query: str) -> bool:
        ...
        searchable_fields = [
            'feature_id', 'gene_name', 'gene_id', 'protein_id',
            'metabolite_id', 'description', 'annotation'
        ]
    ...
    @staticmethod
    def _matches_range(feature_dict: Dict[str, Any], field: str, range_spec: Dict[str, float]) -> bool:
